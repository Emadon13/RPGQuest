...
#include "../../Depressia/gui/window/itemwindow.h"
...
void ItemWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ItemWindow *_t = static_cast<ItemWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ItemWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ItemWindow.data,
